...
export async function getProductById(id) {
    try {
        return await handleResponse(await fetch(`${API_BASE}/products/${id}`));
    }
    catch (error) {
...
export async function createUser(user) {
    try {
        return await handleResponse(await fetch(`${API_BASE}/auth/register`, {
            method: 'POST',
            headers: {
...
export async function saveOrder(order) {
    try {
        return await handleResponse(await fetch(`${API_BASE}/orders`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                ...getAuthHeaders(),
