...
export const comparePage = {
  render: async () => {
    ...
    const compareGrid = container.querySelector<HTMLDivElement>('.compare-grid')!
    ...
    type CompareProduct = NonNullable<Awaited<ReturnType<typeof getProductById>>>
    const rows: Array<{ label: string; value: (product: CompareProduct) => string }> = [
