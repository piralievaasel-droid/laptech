...
export const authPage = {
    ...
    `;
        ...
        const cards = Array.from(container.querySelectorAll('.auth-card'));
        const loginForm = container.querySelector('#login-form');
        const registerForm = container.querySelector('#register-form');
        const loginAlert = container.querySelector('#login-alert');
        const registerAlert = container.querySelector('#register-alert');
